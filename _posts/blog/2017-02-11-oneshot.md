...
One cool thing about this pairwise training is that there are combinatorialy many pairs of images to train the model on.
...
<figure>
	<a href="{{ site.url }}/images/Siamese_diagram_2.jpg" class="image-popup"><img src="{{ site.url }}/images/Siamese_diagram_2.jpg" alt="image"></a>
