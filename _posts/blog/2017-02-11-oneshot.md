...
### Background:
 ...
 !test[test]({{ site.url }}/images/spatula.jpg)
{% include image.html url="/images/spatula.jpg" description="My cat, Robert Downey Jr." %}
...
...[This wonderful paper](http://www.cs.cmu.edu/~rsalakhu/papers/oneshot1.pdf) does just that, using a Siamese Network.

Siamese networks, like every other cool neural net architecture, were [originally thought up in the 90s.](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.590.7750&rep=rep1&type=pdf "Baldi and Chauvin
(1992).")
