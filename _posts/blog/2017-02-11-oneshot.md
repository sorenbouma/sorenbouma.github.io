...
### Background:
 ...
 <figure>
  <img src="/images/spatula.jpg" alt = "image">
  <figcaption>Never been inside a kitchen before? Now's your chance to test your one shot learning ability! which of the images on the right has the same class as big image?
...
<figure>
  <img src="/images/Siamese_diagram_2.png" alt="diagram">
...
Synopsis for laypeople: a convolutional layer is where you use multiple copies of the same neuron for different parts of an array. Lots of these stacked on top of one another are really good at learning from images with gradient descent.
