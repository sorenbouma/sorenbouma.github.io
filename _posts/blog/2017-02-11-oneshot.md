...
So now an interesting problem is *how do we get a neural network to learn the features?* In this tutorial I'll be implementing one of the more simple/obvious ways of doing this.
